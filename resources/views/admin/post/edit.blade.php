                    ...
                    <form action="{{ route('post.update', $post['id']) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $post['title'] }}" class="form-control" id="exampleInputEmail1" name="title" placeholder="Enter post name" required>
                            </div>
                            <!-- Select multiple-->
                            ...
                            <div class="form-group">
                                <textarea name="text" class="editor" id="editor">{{ $post['text'] }}</textarea>
                            </div>
                            <div class="form-group">
